...
import type { NewMemberOnboardingFormData, ValidationErrors } from "@/features/user-management/types";

type StepBasicDetailsProps = {
  basic: NewMemberOnboardingFormData["basic"];
  errors: ValidationErrors;
  onBasicChange: <K extends keyof NewMemberOnboardingFormData["basic"]>(
    field: K,
