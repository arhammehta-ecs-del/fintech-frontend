...
import type { StatusTab } from "@/features/company-list/types";

type CompanyListEmptyStateProps = {
  selectedStatusTab: StatusTab;
  onOpenOnboarding: () => void;
};

export default function CompanyListEmptyState({ selectedStatusTab, onOpenOnboarding }: CompanyListEmptyStateProps) {
  return (
