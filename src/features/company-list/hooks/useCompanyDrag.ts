...
import type { DragPayload } from "@/features/company-list/types";
import { reorderItems } from "@/features/company-list/utils";

type SetGroups = Dispatch<SetStateAction<GroupCompany[]>>;

export function useCompanyDrag(setGroups: SetGroups) {
