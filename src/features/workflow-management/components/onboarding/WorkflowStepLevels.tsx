...
export default function WorkflowStepLevels({
  ...
  return (
    <div className="relative h-full min-h-0 w-full p-3 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <div
          ...
          <div className="relative rounded-xl bg-transparent">
            ...
            {flowCards.map(({ level, idx, x, y }) => (
              <div
                ...
                className={`absolute w-[360px] rounded-[1rem] bg-white p-3 shadow-[0_6px_18px_rgba(15,23,42,0.06)] transition-all ${
                  ...
                  <div className="mt-1.5 space-y-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex-none p-1 text-slate-400 hover:text-red-500 transition-colors"
