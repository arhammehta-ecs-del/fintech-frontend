...
import type { GroupSelectionMode, OnboardingWizardContentProps, SignatoryForm, SignatoryWithId } from "@/features/onboarding/types";
import { emptySignatoryForm, getTodayDateInputValue, onboardingSteps } from "@/features/onboarding/utils";

export function useOnboardingWizard({ embedded = false, open = true, onOpenChange }: OnboardingWizardContentProps = {}) {
