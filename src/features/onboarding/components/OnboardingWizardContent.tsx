...
import { StepGroupCompany } from "@/features/onboarding/components/StepGroupCompany";
import { StepPreviewSubmit } from "@/features/onboarding/components/StepPreviewSubmit";
import { StepSignatory } from "@/features/onboarding/components/StepSignatory";
import { WizardProgressBar } from "@/features/onboarding/components/WizardProgressBar";
import { useOnboardingWizard } from "@/features/onboarding/hooks/useOnboardingWizard";
import type { OnboardingWizardContentProps } from "@/features/onboarding/types";
import { onboardingSteps } from "@/features/onboarding/utils";
...
export function OnboardingWizardContent({
  ...
  const content = (
    ...
    >
      ...
      <WizardProgressBar steps={onboardingSteps} currentStep={step} />
